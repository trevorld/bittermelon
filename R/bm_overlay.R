...
bm_overlay.bm_bitmap <- function(
	...
	bm_overlay_bitmap(over = over, under = under, hjust = hjust, vjust = vjust, bg = bg)
}
...
#' @rdname bm_overlay
#' @export
`bm_overlay.magick-image` <- function(
	x,
	over = NULL,
	under = NULL,
	hjust = "center-left",
	...
	pm <- bm_overlay_bitmap(over = over, under = under, hjust = hjust, vjust = vjust, bg = bg)
	magick::image_read(pm)
}

#' @rdname bm_overlay
#' @export
bm_overlay.nativeRaster <- function(
	x,
	over = NULL,
	under = NULL,
	hjust = "center-left",
