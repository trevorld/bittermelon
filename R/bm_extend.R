...
#' @rdname bm_extend
#' @export
`bm_extend.magick-image` <- function(
	x,
	value = "transparent",
	sides = NULL,
	top = NULL,
...
#' @rdname bm_extend
#' @export
bm_extend.nativeRaster <- function(
	x,
