...
#' @rdname bm_shadow
#' @export
`bm_shadow.magick-image` <- function(
	x,
	value = "black",
	top = NULL,
	right = NULL,
...
#' @rdname bm_shadow
#' @export
bm_shadow.nativeRaster <- function(
	x,
	value = col2int("black"),
	top = NULL,
	right = NULL,
...
bm_shadow_bitmap <- function(
	...
	if (extend) {
		x <- bm_extend(x, value = bg, top = top, right = right, bottom = bottom, left = left)
	}
...
bm_glow.bm_pixmap <- function(
	...
	bm_glow_bitmap(x, value = col2hex(value), bg = col2hex(bg), extend = extend, corner = corner)
}

#' @rdname bm_shadow
#' @export
`bm_glow.magick-image` <- function(
	x,
	value = "black",
	extend = TRUE,
	corner = FALSE,
...
#' @rdname bm_shadow
#' @export
bm_glow.raster <- function(x, value = "black", extend = TRUE, corner = FALSE, bg = "transparent") {
	pm <- bm_glow_bitmap(
		as_bm_pixmap(x),
		value = col2hex(value),
		bg = col2hex(bg),
