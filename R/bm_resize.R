...
bm_resize.bm_bitmap <- function(
	...
	bm_resize_bitmap(x, value = value, width = width, height = height, hjust = hjust, vjust = vjust)
}
...
#' @rdname bm_resize
#' @export
bm_resize.bm_pixmap <- function(
	x,
	value = col2hex("transparent"), # nolint
	width = NULL,
	height = NULL,
	hjust = "center-left",
	vjust = "center-top"
...
#' @rdname bm_resize
#' @export
`bm_resize.magick-image` <- function(
	x,
	value = "transparent", # nolint
	width = NULL,
	height = NULL,
	hjust = "center-left",
	vjust = "center-top"
...
#' @rdname bm_resize
#' @export
bm_resize.nativeRaster <- function(
	x,
	value = col2int("transparent"), # nolint
	width = NULL,
	height = NULL,
	hjust = "center-left",
	vjust = "center-top"
...
bm_resize_bitmap <- function(x, value, width = NULL, height = NULL, hjust = hjust, vjust = vjust) {
