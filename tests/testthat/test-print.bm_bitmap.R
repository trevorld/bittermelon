test_that("print.bm_bitmap()", {
	...
	verify_output(
		"txt/plus_unicode_color_char.txt",
		{
	...
	verify_output(
		"txt/plus_unicode_color_options.txt",
		{
			withr::with_options(
				list(
					bittermelon.px = px_ascii,
