...
test_that("bm_trim()", {
	...
	verify_output("txt/capital_r_trimmed.txt", {
		...
		print(bm_trim(capital_r, c(1, 1, 3, 0)), px = c("-", "#"))
		print(bm_trim(capital_r, height = 8, vjust = "top"), px = c("-", "#"))
		print(bm_trim(bm_list(capital_r), height = 8, vjust = "top"), px = c("-", "#"))
		print(bm_trim(capital_r, height = 8, vjust = "bottom"), px = c("-", "#"))
		print(bm_trim(capital_r, width = 4, hjust = "left"), px = c("-", "#"))
		print(bm_trim(capital_r, width = 4, hjust = "right"), px = c("-", "#"))
	})
	...
	verify_output("txt/capital_r_resized.txt", print(capital_r_resized, px = c("-", "#")))
	verify_output("txt/capital_r_resized2.txt", print(capital_r_resized2, px = c("-", "#")))
})
...
test_that("bm_shadow", {
	...
	verify_output("txt/capital_r_glow.txt", print(bm_glow(capital_r), px = px_ascii))
	verify_output(
		"txt/capital_r_glow_corner.txt",
