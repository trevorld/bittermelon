...
test_that("`bm_extend.nativeRaster()`", {
	...
	verify_output(
		"txt/bm_extend_nativeRaster.txt",
		{
			m <- matrix(c("blue", "yellow"), nrow = 2L, ncol = 2L)
